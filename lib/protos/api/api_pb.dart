...
class Request extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('Request', package: const $pb.PackageName('api'))
    ...
    ..a<LinRead>(14, 'linRead', $pb.PbFieldType.OM, LinRead.getDefault, LinRead.create)
    ..aOB(15, 'readOnly')
...
class Response extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('Response', package: const $pb.PackageName('api'))
    ...
    ..pp<SchemaNode>(2, 'schema', $pb.PbFieldType.PM, SchemaNode.$checkItem, SchemaNode.create)
    ..a<TxnContext>(3, 'txn', $pb.PbFieldType.OM, TxnContext.getDefault, TxnContext.create)
    ..a<Latency>(12, 'latency', $pb.PbFieldType.OM, Latency.getDefault, Latency.create)
    ..hasRequiredFields = false
  ;
  ...
  set json(List<int> v) { $_setBytes(0, v); }
  bool hasJson() => $_has(0);
  ...
  set txn(TxnContext v) { setField(3, v); }
  bool hasTxn() => $_has(2);
  void clearTxn() => clearField(3);

  Latency get latency => $_getN(3);
  set latency(Latency v) { setField(12, v); }
  bool hasLatency() => $_has(3);
  void clearLatency() => clearField(12);
}

class Assigned extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('Assigned', package: const $pb.PackageName('api'))
    ..m<String, String>(1, 'uids', $pb.PbFieldType.OS, $pb.PbFieldType.OS)
    ..a<TxnContext>(2, 'context', $pb.PbFieldType.OM, TxnContext.getDefault, TxnContext.create)
    ..a<Latency>(12, 'latency', $pb.PbFieldType.OM, Latency.getDefault, Latency.create)
    ..hasRequiredFields = false
  ;

  Assigned() : super();
  Assigned.fromBuffer(List<int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Assigned.fromJson(String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Assigned clone() => new Assigned()..mergeFromMessage(this);
  Assigned copyWith(void Function(Assigned) updates) => super.copyWith((message) => updates(message as Assigned));
  $pb.BuilderInfo get info_ => _i;
  ...
  set context(TxnContext v) { setField(2, v); }
...
class Mutation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('Mutation', package: const $pb.PackageName('api'))
  ...
  Mutation() : super();
  Mutation.fromBuffer(List<int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Mutation.fromJson(String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class TxnContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('TxnContext', package: const $pb.PackageName('api'))
    ..a<Int64>(1, 'startTs', $pb.PbFieldType.OU6, Int64.ZERO)
    ..a<Int64>(2, 'commitTs', $pb.PbFieldType.OU6, Int64.ZERO)
    ..aOB(3, 'aborted')
    ..pPS(4, 'keys')
    ..pPS(5, 'preds')
    ..a<LinRead>(13, 'linRead', $pb.PbFieldType.OM, LinRead.getDefault, LinRead.create)
    ..hasRequiredFields = false
  ;

  TxnContext() : super();
  TxnContext.fromBuffer(List<int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  TxnContext.fromJson(String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  TxnContext clone() => new TxnContext()..mergeFromMessage(this);
  TxnContext copyWith(void Function(TxnContext) updates) => super.copyWith((message) => updates(message as TxnContext));
  $pb.BuilderInfo get info_ => _i;
  static TxnContext create() => new TxnContext();
  static $pb.PbList<TxnContext> createRepeated() => new $pb.PbList<TxnContext>();
  ...
  set linRead(LinRead v) { setField(13, v); }
  bool hasLinRead() => $_has(5);
  void clearLinRead() => clearField(13);
}

class Check extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('Check', package: const $pb.PackageName('api'))
    ..hasRequiredFields = false
  ;

  Check() : super();
  Check.fromBuffer(List<int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Check.fromJson(String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Check clone() => new Check()..mergeFromMessage(this);
  Check copyWith(void Function(Check) updates) => super.copyWith((message) => updates(message as Check));
  $pb.BuilderInfo get info_ => _i;
...
class Version extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('Version', package: const $pb.PackageName('api'))
    ..aOS(1, 'tag')
    ..hasRequiredFields = false
  ;
...
class LinRead extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('LinRead', package: const $pb.PackageName('api'))
    ..m<int, Int64>(1, 'ids', $pb.PbFieldType.OU3, $pb.PbFieldType.OU6)
    ..e<LinRead_Sequencing>(2, 'sequencing', $pb.PbFieldType.OE, LinRead_Sequencing.CLIENT_SIDE, LinRead_Sequencing.valueOf, LinRead_Sequencing.values)
    ..hasRequiredFields = false
  ;

  LinRead() : super();
  LinRead.fromBuffer(List<int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  LinRead.fromJson(String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  LinRead clone() => new LinRead()..mergeFromMessage(this);
  LinRead copyWith(void Function(LinRead) updates) => super.copyWith((message) => updates(message as LinRead));
  $pb.BuilderInfo get info_ => _i;
  ...
  set sequencing(LinRead_Sequencing v) { setField(2, v); }
  bool hasSequencing() => $_has(1);
  void clearSequencing() => clearField(2);
}

class Latency extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('Latency', package: const $pb.PackageName('api'))
  ...
  Latency() : super();
  Latency.fromBuffer(List<int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Latency.fromJson(String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Latency clone() => new Latency()..mergeFromMessage(this);
  Latency copyWith(void Function(Latency) updates) => super.copyWith((message) => updates(message as Latency));
  $pb.BuilderInfo get info_ => _i;
...
class NQuad extends $pb.GeneratedMessage {
  ...
  NQuad() : super();
  NQuad.fromBuffer(List<int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  NQuad.fromJson(String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  NQuad clone() => new NQuad()..mergeFromMessage(this);
  NQuad copyWith(void Function(NQuad) updates) => super.copyWith((message) => updates(message as NQuad));
  $pb.BuilderInfo get info_ => _i;
...
class Value extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('Value', package: const $pb.PackageName('api'))
    ..aOS(1, 'defaultVal')
...
class Facet extends $pb.GeneratedMessage {
  ...
  Facet() : super();
  Facet.fromBuffer(List<int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  Facet.fromJson(String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  Facet clone() => new Facet()..mergeFromMessage(this);
  Facet copyWith(void Function(Facet) updates) => super.copyWith((message) => updates(message as Facet));
  $pb.BuilderInfo get info_ => _i;
  ...
  set alias(String v) { $_setString(4, v); }
  bool hasAlias() => $_has(4);
  void clearAlias() => clearField(5);
}

class SchemaNode extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = new $pb.BuilderInfo('SchemaNode', package: const $pb.PackageName('api'))
    ..aOS(1, 'predicate')
    ..aOS(2, 'type')
    ..aOB(3, 'index')
    ..pPS(4, 'tokenizer')
  ...
  SchemaNode() : super();
  SchemaNode.fromBuffer(List<int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  SchemaNode.fromJson(String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  SchemaNode clone() => new SchemaNode()..mergeFromMessage(this);
  SchemaNode copyWith(void Function(SchemaNode) updates) => super.copyWith((message) => updates(message as SchemaNode));
  $pb.BuilderInfo get info_ => _i;
  static SchemaNode create() => new SchemaNode();
  static $pb.PbList<SchemaNode> createRepeated() => new $pb.PbList<SchemaNode>();
  ...
  set predicate(String v) { $_setString(0, v); }
...
class DgraphApi {
  ...
  $async.Future<Assigned> mutate($pb.ClientContext ctx, Mutation request) {
    ...
    return _client.invoke<Assigned>(ctx, 'Dgraph', 'Mutate', request, emptyResponse);
  }
